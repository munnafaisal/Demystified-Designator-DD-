...
schedule_meeting_function = {
    ...
    "description": "Re-schedules a booking with at a given booking ID, time and date.",
    "parameters": {
        "type": "object",
        "properties": {
            ...
            "booking_id": {
                "type": "string",
                "description": "Booking ID of an previously confirmed appointment",
            },
            "date": {
                "type": "string",
...
def get_reschedule_func_response(query):
